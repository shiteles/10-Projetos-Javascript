...
const coresEstrelas =["red","orange","yellow","MediumSpringGreen","green"];


atualizaAvaliacao(0);
starsEl.forEach((starsEl, index) => {
    starsEl.addEventListener("click", () => {
        atualizaAvaliacao(index)
    });
});

function atualizaAvaliacao(index){
    ...
    emojisEl.forEach((emojiEl) => {
        ...
        emojiEl.style.color = coresEstrelas[index]
    });
}